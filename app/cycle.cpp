...
void initialize_docking()
{
    ...
    if(!ImGui::DockBuilderGetNode(dockspace_id))
    {
        ...
        ImGui::DockBuilderDockWindow("###plots", dock_left);
        ImGui::DockBuilderDockWindow("Scene", dock_left);
        ImGui::DockBuilderDockWindow("###hierarchy", dock_left);

        ImGui::DockBuilderDockWindow("###scenesettings", dock_left);
        ImGui::DockBuilderDockWindow("###editorsettings", dock_left);
        ImGui::DockBuilderDockWindow("###projectsettings", dock_left);
